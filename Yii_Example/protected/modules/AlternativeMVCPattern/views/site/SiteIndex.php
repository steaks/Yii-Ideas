...
<h2>New Files Relevant For all pages</h2>
  <ul>
    <li class="Bold">Parent Contoller: <tt><?php echo Yii::app()->getBasePath().'/components/MyController.php'?></tt></li>
    <li class="Bold">Parent View Model: <tt><?php echo Yii::app()->getBasePath().'/components/MyViewModel.php'?></tt></li>
  </ul>
